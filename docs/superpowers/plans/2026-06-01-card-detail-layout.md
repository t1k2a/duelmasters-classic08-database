...
<div class="flex h-[calc(100vh-52px)]">
  ...
  <div class="flex-1 md:flex-none md:w-56 flex flex-col overflow-hidden border-r border-gray-200 bg-gray-50 shrink-0">
  ...
  <div id="detailPanel" class="hidden md:flex flex-col flex-1 bg-white overflow-y-auto">
    <div class="p-5 text-sm text-gray-400 text-center mt-8">カードをクリックすると<br>詳細が表示されます</div>
  </div>
...
```bash
grep -c "<aside\|<main\b\|md:flex-none md:w-56\|flex-1 bg-white overflow-y-auto" docs/design-preview.html
```
...
- `flex-1 bg-white overflow-y-auto` → 1（右カラム `detailPanel`）
