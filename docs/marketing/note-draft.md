...
![デュエル・マスターズ クラシック08 データベースのトップページ（カード検索一覧・2,171枚収録）](images/top.png)
...
現時点で収録しているのは、**カード2,171枚**と**デッキレシピ462件**です。
主な機能はこんな感じです。
...
![メタデッキTier表ページ（ボルメテウスコントロール／天門／サバキストライクなどの主要デッキ解説）](images/meta.png)
