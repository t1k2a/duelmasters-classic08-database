...
デュエル・マスターズ **クラシック08環境** のカード検索・デッキ構築・メタ分析ができる静的Webデータベースです。全 **2,171枚** のカードと **462件** のデッキレシピを収録しています。
...
- **カード検索** — 全2,171枚を文明（光/水/闇/火/自然）・種類・コスト・種族・パック・パワー・レアリティ・特殊能力で絞り込み。名前/テキストのインクリメンタル検索とハイライト対応。リスト/グリッドの表示切替。
